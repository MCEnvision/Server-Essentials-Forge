...
- [Trident testing decision](general/research/sources/trident-testing.md). Laptop instance lifecycle, existing authentication, unchanged audio and runtime evidence boundaries.
