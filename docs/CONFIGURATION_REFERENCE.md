...
| `runtime.enable_disguises` | Enable disguise commands and state | boolean | `false` | `true` or `false` | boolean flag | restart_required | public | `runtime.enable_disguises = false` |
| `runtime.enable_fancy_tags` | Enable Fancy Tags metadata, commands, assignments, and command fallback | boolean | `false` | `true` or `false` | boolean flag | restart_required | public | `runtime.enable_fancy_tags = false` |
