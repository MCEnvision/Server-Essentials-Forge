...
| laptop client and audio watcher | disposable client PID `3909330` terminated before cleanup; stream node `148` was muted and disappeared; personal FutureShops client and stream were preserved |
