...
The candidate artifact is `sef-2.0.0.jar`, 3,385,079 bytes, with SHA 256 `894c28c9e4a0f9be1f0f2bc727e84a7f03c9402bbaa679b2035fe83b9702ccf9` and SHA 512 `f837627cf581a9de4130914d2b84d5986f2c9a83c8078dc031a3740b61bf0151982a42671be20be473bbb2c62e20f13d6b87647c618e42cd3a8789a83fb20257`. Two independent clean JAR builds at the current revision produced the same digest after archive reproducibility was enabled. Historical hosted matrix run `33671017902` inspected the preceding candidate on Linux, macOS, and Windows. The current revision still requires a fresh hosted cross-platform digest binding. The JAR does not embed Netty, Log4j, Commons, Guava, or Plexus libraries, so a Gradle resolution override cannot remediate the libraries supplied by an installed NeoForge runtime.
