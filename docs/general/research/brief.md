...
- Audit operation under finite storage. SEF-REQ-024, SEF-REQ-026 and SEF-REQ-031, DEC-010 through DEC-013. MySQL/MariaDB, manual normal retention and visible emergency oldest-segment rotation are resolved. No finite store can promise unbounded retained history.
