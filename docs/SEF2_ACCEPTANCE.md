...
- The current JAR is `sef-2.0.0.jar`, 3,385,524 bytes, with SHA-256 `43195e53fdefc35c10355cea92ee73f8f8cc1144558e771986bc7f5779065a4c` and SHA-512 `a446197b204c02f4feac105d34448145ba49af323eafb238d62cda264ddacdc674bd8a0a8c61d1f5b114019d6eba424bcd13023b6d257b2b740208f145a23567`. The hosted candidate artifact is bound to commit `05a8b56910e11a9fd5788192d721ffb9ec49f494`. Hosted matrix run `33699326402` inspected the matching candidate on Linux, macOS, and Windows.
- Hosted matrix run `33699326402` passed the candidate build, 530 unit tests, 41 required GameTests, native provider smoke, dependency insight, ZIP validation, and duplicate native runtime scan on Linux, macOS, and Windows. Full `EXT-001` still requires direct client and server workflow, rotation, restart, failure preservation, and fixture trace evidence.
