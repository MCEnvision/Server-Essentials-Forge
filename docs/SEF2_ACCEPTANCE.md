...
- The current JAR is `sef-2.0.0.jar`, 3,386,731 bytes, with SHA-256 `ea805475a9f692de52b052587cb5e47324b4a083b8261ff429fe477c623248c7` and SHA-512 `a33e083f10a3ab6476c1965e689ffdd5cd22c7773ce0f1428e0a8c0cb9bb3aca4cbe2557d2b89384430a0b08c0f742e81dadb7cc45e0828e852dde5c4b80ddeb`. The hosted candidate artifact is bound to commit `d0911559c48fe81216e58a5a28a5c7ccaa987777`. Hosted matrix run `33707453265` inspected the matching candidate on Linux, macOS, and Windows.
- Hosted matrix run `33707453265` passed the candidate build, 530 unit tests, 41 required GameTests, native provider smoke, disposable writer probe, dependency insight, ZIP validation, and duplicate native runtime scan on Linux, macOS, and Windows. Full `EXT-001` still requires direct client and server workflow and fixture trace evidence.
