...
- The current JAR is `sef-2.0.0.jar`, 3,386,731 bytes, with SHA-256 `ea805475a9f692de52b052587cb5e47324b4a083b8261ff429fe477c623248c7` and SHA-512 `a33e083f10a3ab6476c1965e689ffdd5cd22c7773ce0f1428e0a8c0cb9bb3aca4cbe2557d2b89384430a0b08c0f742e81dadb7cc45e0828e852dde5c4b80ddeb`. The hosted candidate artifact is bound to commit `02cf42bac17405daf16ec3a1036453e64e72232`. Hosted matrix run `33704780764` inspected the matching candidate on Linux, macOS, and Windows.
- Hosted matrix run `33704780764` passed the candidate build, 530 unit tests, 41 required GameTests, native provider smoke, dependency insight, ZIP validation, and duplicate native runtime scan on Linux, macOS, and Windows. Full `EXT-001` still requires direct client and server workflow, rotation, restart, failure preservation, and fixture trace evidence.
