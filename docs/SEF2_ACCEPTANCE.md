...
- The current JAR is `sef-2.0.0.jar`, 3,389,485 bytes, with SHA-256 `da76826dd757e9f52b1cfc61fb9902812a77c328321edae14428f329c2a16eb0` and SHA-512 `ebef0a8b845576ad6a5fb635bd6ac5b79bd4de813b180ce5e2600e8397743b8871d3a5955eaa70437dbb064bd3af50e6c06904187b6556e309035b050cbafd2c`. The hosted candidate artifact is bound to commit `aa136e171b80c3e6d9c1dbc27c1c9a9a1d10c0c1`. Hosted matrix run `33724030963` inspected the matching candidate on Linux, macOS, and Windows.
- Hosted matrix run `33724030963` passed the candidate build, 530 unit tests, 41 required GameTests, native provider smoke, disposable writer probe, opened object identity traces, rejected target preservation, dependency insight, ZIP validation, duplicate native runtime scan, packaged dedicated server workflow, and packaged client startup workflow on Linux, macOS, and Windows. Ubuntu verified LWJGL and GUI atlas startup. macOS and Windows recorded explicit hosted display blockers in `client-runtime-manifest.txt`. Full `EXT-001` still requires direct graphical client workflows and the complete platform specific failure matrix.
