...
The current Phase 003 candidate is product commit `0f4a6af9fcc6a7279d38546fc1b40b9f5579e586` on `envy/phase-003-commands`. The control gate now covers the two custom lease paths that previously called command execution directly. The catalog denial regression checks all 694 sealed actions, proves callbacks are blocked, and records bounded feedback with redacted denial audit events. The clean checkout passes the full check and build, all 44 required GameTests, the native writer probe, dependency manifest generation, and inventory generation. The candidate JAR is `sef-2.0.0.jar`, 3,404,504 bytes, SHA-256 `602dffd7eac94e930916984b2d1bf0a66b3eaa8940f53e9624c79bbd95f84bc1`, and SHA-512 `4c32fecc0382e9937c0816d85a73540fdabfd5b7ad3e498d59735d561626d361e8a1e30afe16bedc20c1bcb93591c44f61c3a10f2cd9f9eeed0498c3d9de5c99`, bound by task 089. Task 090 rebinds the universal matrix to the current evidence packet. The matrix remains intentionally incomplete with 710 rows, 694 executable rows open, 16 unavailable rows passed, and `complete=false`. The external platform supplied dependency alert ownership and advisory closure record remains open. This is a current Phase 003 progress record, not final acceptance.
...
- The current Phase 003 JAR is `sef-2.0.0.jar`, 3,404,504 bytes, with SHA-256 `602dffd7eac94e930916984b2d1bf0a66b3eaa8940f53e9624c79bbd95f84bc1` and SHA-512 `4c32fecc0382e9937c0816d85a73540fdabfd5b7ad3e498d59735d561626d361e8a1e30afe16bedc20c1bcb93591c44f61c3a10f2cd9f9eeed0498c3d9de5c99`. It is bound to product commit `0f4a6af9fcc6a7279d38546fc1b40b9f5579e586` in the task 089 remediation packet. Task 090 binds the regenerated matrix to that packet. The current clean Linux build and GameTest evidence pass; affected native and cross host rows remain governed by the conditional host plan.
