...
Measured on 2026-09-04 with Java `21.0.11`, 20 available processors, Minecraft `1.21.1`, and NeoForge `21.1.235`.
...
| --- | ---: | ---: | ---: | --- |
| Generate the complete modular configuration reference | 100 | 289 ms | 10000 ms | pass |
| Generate the complete command reference | 1 | 4 ms | 10000 ms | pass |
| Generate the complete permission reference | 1 | 12 ms | 10000 ms | pass |
| Resolve sealed command catalog entries | 250000 | 19 ms | 5000 ms | pass |
| Resolve typed server control schemas | 250000 | 103 ms | 5000 ms | pass |
