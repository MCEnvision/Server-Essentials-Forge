...
Measured on 2026-07-27 with Java `21.0.11`, 20 available processors, Minecraft `1.21.1`, and NeoForge `21.1.233`.
...
| --- | ---: | ---: | ---: | --- |
| Generate the complete modular configuration reference | 100 | 316 ms | 10000 ms | pass |
