 ...
 * Persists data to <world>/serverconfig/bfcrr/alt_data.json.
 *
 * Data structure:
...
public class AltTracker {
    ...
    public void load(MinecraftServer server) {
        ...
        try (Reader reader = Files.newBufferedReader(filePath)) {
            ...
            BetterForgeChat.LOGGER.info("[BFCRR] Loaded alt data for {} IP(s)", ipMap.size());
        } catch (Exception e) {
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to load alt data", e);
        }
    }
    ...
    public void save() {
        ...
        try {
            ...
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to save alt data", e);
        }
    }
