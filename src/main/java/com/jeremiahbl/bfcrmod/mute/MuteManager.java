package com.jeremiahbl.bfcrmod.mute;
 ...
 * <p>
 * Mute data is saved to {@code <world>/serverconfig/bfcrr/mutes.json} and
...
public class MuteManager {
    ...
    public void load(MinecraftServer server) {
        filePath = server.getWorldPath(net.minecraft.world.level.storage.LevelResource.ROOT)
                .resolve("serverconfig").resolve("bfcrr").resolve("mutes.json");
        ...
        try (Reader reader = Files.newBufferedReader(filePath)) {
            ...
            BetterForgeChat.LOGGER.info("[BFCRR] Loaded {} persistent mute(s)", mutes.size());
        } catch (Exception e) {
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to load mutes", e);
        }
    }
    ...
    public void save() {
        ...
        try {
            ...
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to save mutes", e);
        }
    }
    ...
    public void mutePlayer(ServerPlayer target, String adminName, String reason,
        ...
        BetterForgeChat.LOGGER.info("[MUTE] {} muted by {} for {} - Reason: {}",
    ...
    public MuteEntry unmutePlayer(UUID playerUUID, String adminName, MinecraftServer server) {
        ...
        BetterForgeChat.LOGGER.info("[MUTE] {} unmuted by {}", entry.playerName, adminName);
        return entry;
    }
    ...
    public void tick(MinecraftServer server) {
        ...
        while (it.hasNext()) {
            ...
            if (entry.remainingTicks <= 0) {
                ...
                BetterForgeChat.LOGGER.info("[MUTE] {} auto-unmuted (mute expired)", entry.playerName);
            }
        }
