package com.jeremiahbl.bfcrmod.announcements;
...
/**
 * Manages scheduled server announcements (text & command) stored in serverconfig/bfcrr/announcements.json.
 */
public class AnnouncementManager {
    ...
    private void loadAnnouncements() {
        ...
        try (Reader reader = Files.newBufferedReader(filePath)) {
            ...
            BetterForgeChat.LOGGER.info("[BFCRR] Loaded {} announcement(s)", announcements.size());
        } catch (Exception e) {
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to load announcements", e);
        }
    }
    ...
    private void loadPrefs() {
        ...
        try (Reader reader = Files.newBufferedReader(prefsPath)) {
            ...
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to load announcement prefs", e);
        }
    }
    ...
    public void save() {
        ...
        try {
            ...
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to save announcements", e);
        }
    }
    ...
    private void savePrefs() {
        ...
        try {
            ...
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to save announcement prefs", e);
        }
    }
