 ...
 * Data is saved to <world>/serverconfig/bfcrr/warns.json.
 *
...
public class WarnManager {
    ...
    public void load(MinecraftServer server) {
        ...
        try (Reader reader = Files.newBufferedReader(filePath)) {
            ...
            BetterForgeChat.LOGGER.info("[BFCRR] Loaded {} warning(s) for {} player(s)", total, warns.size());
        } catch (Exception e) {
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to load warns", e);
        }
    }
    ...
    public void save() {
        ...
        try {
            ...
            BetterForgeChat.LOGGER.error("[BFCRR] Failed to save warns", e);
        }
    }
