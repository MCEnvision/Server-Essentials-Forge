...
public class InvSeeContainer extends AbstractContainerMenu {
    ...
    private void addDecoSlot(int displayIdx, int x, int y, String label) {
        ...
        pane.set(net.minecraft.core.component.DataComponents.CUSTOM_NAME, TextFormatter.stringToFormattedText(label));
    ...
    private void addNavSlot(int displayIdx, int x, int y, String label, int targetPage) {
        ...
        arrow.set(net.minecraft.core.component.DataComponents.CUSTOM_NAME, TextFormatter.stringToFormattedText(label));
